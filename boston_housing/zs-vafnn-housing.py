...
if __name__ == '__main__':
    ...
    for X_train, y_train, X_test, y_test in train_test_set:
        ...
        train_lbs.append(fold_train_lbs)
        train_rmses.append(fold_train_rmses)
        train_lls.append(fold_train_lls)
        test_lbs.append(fold_test_lbs)
        test_rmses.append(fold_test_rmses)
        test_lls.append(fold_test_lls)
    if(plot_performance):
